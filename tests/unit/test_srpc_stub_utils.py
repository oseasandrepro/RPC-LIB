from srpcLib.utils import srpc_stub
...
class TestSrpcStubUtils:
    ...
    def test_check_file_type_hints_sucess(self):
        ...
        passed, msg = srpc_stub.check_file_type_hints(file_path)
